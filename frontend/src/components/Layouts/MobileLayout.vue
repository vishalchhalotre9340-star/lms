<template>
	<div class="relative flex h-screen min-w-0 flex-col overflow-hidden bg-surface-gray-1 text-ink-gray-9">
		<div
			class="flex min-h-0 flex-1 flex-col overflow-x-hidden overflow-y-auto bg-surface-gray-1 pb-24"
			id="scrollContainer"
		>
			<slot />
		</div>
